...
export function CampaignHero(){
 ...
 return <section id="inicio" className="campaign" aria-labelledby="campaign-title">
  ...
  <div className="campaign-copy"><p className="campaign-kicker" data-hero-motion>HARMONIZAÇÃO FACIAL <span>RECIFE · SURUBIM</span></p><h1 id="campaign-title"><span data-hero-motion>A beleza</span><span data-hero-motion>de ser</span><em data-hero-motion>você.</em></h1><div className="campaign-description" data-hero-motion><span className="fine-rule"/><p>Um olhar sensível para os seus traços.<br/>Uma forma única de realçar a sua essência.</p></div><div className="campaign-actions"><a className="campaign-cta booking-cta" href={appointmentUrl} target="_blank" rel="noreferrer" data-hero-motion>Agendar minha avaliação <ArrowUpRight size={20}/></a><Link className="campaign-intake-cta" href="/pre-anamnese" data-hero-motion><ClipboardList size={20} aria-hidden="true"/>Pré-anamnese</Link></div></div>
