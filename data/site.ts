...
export const site = {
  ...
  phone: '(81) 98587-7074', whatsapp: '5581985877074', whatsappUrl: '',
  ...
  images: { hero: '/images/paula-clinica-hq.webp', about: '/images/paula-por-tras-do-cuidado-retrato.webp', beauty: '/images/paula-cuidado.webp' },
  procedures: [
    ...
    { name: 'Preenchimentos faciais', description: 'Preenchimentos para as diferentes regiões do rosto, como lábios, olheiras, maçãs do rosto, mento, mandíbula e sulcos. Cada indicação parte de uma avaliação individual das suas proporções.', image: '/images/resultado-equilibrio.webp' },
    { name: 'Lipo de papada', description: 'Cuidado com a região abaixo do queixo e com o contorno entre face e pescoço, a partir de uma avaliação individual e de um planejamento para você.', image: '/images/resultado-lipo-papada.webp' },
  ...
  results: { enabled: true, items: [
    ...
    { image: '/images/resultado-delicadeza-labial.webp', label: 'Delicadeza nos contornos', alt: 'Detalhe frontal dos lábios em fotografia clínica da Dra. Paula Brito', orientation: 'single', beforeShare: .5, comparisonRatio: 900/1600 },
    ...
    { image: '/images/resultado-desenho-labial.webp', label: 'Desenho e delicadeza', alt: 'Detalhe lateral dos lábios, portfólio da Dra. Paula Brito', orientation: 'single', beforeShare: .5, comparisonRatio: 900/1600 },
    { image: '/images/resultado-lipo-papada.webp', label: 'Lipo de papada', alt: 'Antes e depois de lipo de papada, registro enviado pela Dra. Paula Brito', orientation: 'horizontal', beforeShare: 650/1284, comparisonRatio: 642/1282 },
    { image: '/images/resultado-cuidado-facial.webp', label: 'O cuidado em cada traço', alt: 'Comparativo frontal do rosto, registro enviado pela Dra. Paula Brito', orientation: 'horizontal', beforeShare: .5, comparisonRatio: 900/1453 },
  ] },
